...
#define KILLER_COUNT 40
#define PERK_KILLER_COUNT 133
#define KILLER_ADDON_COUNT 20
#define SURVIVOR_COUNT 46
#define PERK_SURVIVOR_COUNT 152
...
#define MAP_ADDON_COUNT 9
#define KEY_ADDON_COUNT 9
#define SURVIVOR_ITEM_COUNT 5
#define KILLER_OFFERING_COUNT 39
#define SURVIVOR_OFFERING_COUNT 43
// history txt
#define HISTORY_FILE "DBD 9.1.0 History.txt"
...
int main () {
    ...
    char *perkSurvivorList[PERK_SURVIVOR_COUNT] = {
        ...
        /*"Apocalpytic Ingenuity",*/ "Appraisal", "Autodidact", "Babysitter", "Background Player",
        ...
        "Flip-Flop", "Fogwise", "For The People", "Friendly Competition", "Hardened",
        "Head On", "Hope", "Hyperfocus", "Inner Focus", "Inner Strength",
        //page 6
        "Invocation: Treacherous Crows", "Invocation: Weaving Spiders", "Iron Will", "Kindred", /*"Last Stand",*/
        "Leader", "Left Behind", "Light-Footed", "Lightweight", "Lithe",
        "Low Profile", "Lucky Break", "Lucky Star", "Made For This", "Mettle Of Man",
        //page 7
        "Mirrored Illusion", "Moment Of Glory", "No Mither", "No One Left Behind", "Object Of Obsession",
        "Off The Record", "Open-Handed", "Overcome", "Overzealous", "Parental Guidance",
        "Pharmacy", "Plot Twist", "Plunderer's Instinct", "Poised", "Potential Energy",
        //page 8
        "Power Struggle", "Premonition", "Prove Thyself", "Quick & Quiet", "Quick Gambit",
        "Rapid Response", "Reactive Healing", "Reassurance", "Red Herring", "Repressed Alliance",
        "Residual Manifest", "Resilience", "Resurgence", "Rookie Spirit", "Saboteur",
        //page 9
        "Scavenger", "Scene Partner", "Second Wind", "Self-Care", "Self-Preservation",
        "Shoulder The Burden", "Slippery Meat", "Small Game", "Smash Hit",
        "Solidarity", "Soul Guard", "Specialist", "Spine Chill", "Sprint Burst",
        //page 10
        "Stake Out", "Still Sight", "Streetwise", "Strength In Shadows", "Teamwork: Collective Stealth",
        "Teamwork: Power Of Two", /*"Teamwork: Throw Down", "Teamwork: Toughen Up",*/ "Technician", "Tenacity",
        "This Is Not Happening", "Troubleshooter", "Unbreakable", "Up The Ante", "Urban Evasion",
        //page 11
        "Vigil", "Visionary", "Wake Up!", "We'll Make It", "We're Gonna Live Forever",
        "Wicked", "Windows Of Opportunity", "Wiretap"
    };
    ...
    char *mapAddon[MAP_ADDON_COUNT] = {
        "Crystal Bead", "Black Silk Cord", "Odd Stamp", "Glass Bead", "Red Twine", "Retardant Jelly", "Unusual Stamp", "Yellow Wire", "Map Addendum"
    };
    char *mapAddonRarity[MAP_ADDON_COUNT] = {
        "Very Rare", "Rare", "Rare", "Uncommon", "Uncommon", "Uncommon", "Uncommon", "Uncommon", "Common"
    };
    ...
    char *keyRarity[KEY_COUNT] = {
        "Visceral", "Very Rare", "Rare"
    };
    char *keyAddon[KEY_ADDON_COUNT] = {
        "Blood Amber", "Milky Glass", "Unique Wedding Ring", "Weaved Ring", "Gold Token", "Eroded Token", "Prayer Beads", "Scratched Pearl", "Prayer Rope"
    };
    char *keyAddonRarity[KEY_ADDON_COUNT] = {
        "Very Rare", "Very Rare", "Very Rare", "Very Rare", "Rare", "Uncommon", "Uncommon", "Uncommon", "Common"
    };
    ...
    char *perkKillerList[PERK_KILLER_COUNT] = {
        ...
        "Hex: Pentimento", "Hex: Plaything", "Hex: Retribution", "Hex: Ruin", "Hex: The Third Seal",
        //page 5
        "Hex: Thrill Of The Hunt", "Hex: Two Can Play", "Hex: Undying", "Hex: Wretched Fate", "Hoarder",
        "Hubris", "Human Greed", "Hysteria", "I'm All Ears", "Infectious Fright",
        "Insidious", "Iron Grasp", "Iron Maiden", "Knock Out", "Languid Touch",
        //page 6
        "Lethal Pursuer", "Leverage", "Lightborn", "Machine Learning", "Mad Grit",
        "Make Your Choice", "Merciless Storm", "Mindbreaker", "Monitor & Abuse", "Nemesis",
        "No Quarter", "No Way Out", "None Are Free", "Nowhere To Hide", "Oppression",
        //page 7
        "Overcharge", "Overwhelming Presence", "Phantom Fear", "Play With Your Food", "Pop Goes The Weasel",
        "Predator", "Rancor", "Rapid Brutality", "Remember Me", "Save The Best For Last",
        "Scourge Hook: Floods Of Rage", "Scourge Hook: Gift Of Pain", "Scourge Hook: Hangman's Trick", "Scourge Hook: Jagged Compass", "Scourge Hook: Monstrous Shrine",
        //page 8
        "Scourge Hook: Pain Resonance", "Septic Touch", "Shadowborn", "Shattered Hope", "Sloppy Butcher",
        "Spies From The Shadows", "Spirit Fury", "Starstruck", "Stridor", "Superior Anatomy",
        "Surge", "Surveillance", "Terminus", "Territorial Imperative", "Thanatophobia",
        //page 9
        "Thrilling Tremors", "Thwack!", "Tinkerer", "Trail of Torment", "Ultimate Weapon",
        "Unbound", "Undone", "Unforeseen", "Unnerving Presence", "Unrelenting",
        "Weave Attunement", "Whispers", "Zanshin Tactics" 
    };
    ...
    char *shapeAddons[KILLER_ADDON_COUNT] = {
        "Fragrant Tuft Of Hair", "Judith's Tombstone", "Lock Of Hair", "Scratched Mirror", "Tombstone Piece",
        "Vanity Mirror", "Hair Bow", "J.Myers Memorial", "Jewelry Box", "Judith's Journal",
        "Mirror Shard", "Dead Rabbit", "Glass Fragment", "Hair Brush", "Jewelry",
        "Reflective Fragment", "Blond Hair", "Boyfriend's Memo", "Memorial Flower", "Tacky Earrings"
    };
    ...
    srand(time(NULL));
    // terminal main menu
    printf("Dead by Daylight Randomizer 9.0.2 v1\n");
    printf("By DoggieSquad\n");
    printf("1. Killer\n");
    printf("2. Survivor\n");
    //printf("3. Scan ID (WILL FINISH LATER)\n");
    printf("3. Exit\n");
...
//DBD RANDOMIZER BY DOGGIESQUAD 7/9/2025
