...
// history txt
#define HISTORY_FILE "DBD 9.1.3 History.txt"
...
int main () {
    ...
    char *map[MAP_COUNT] = {
        "Cryptic Map", "Annotated Map", "Scribbled Map"
    };
    ...
    srand(time(NULL));
    // terminal main menu
    printf("Dead by Daylight Randomizer 9.1.3 v2\n");
...
//DBD RANDOMIZER BY DOGGIESQUAD 9/8/2025
