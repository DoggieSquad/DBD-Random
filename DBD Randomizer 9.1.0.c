...
#define SURVIVOR_COUNT 48
#define PERK_SURVIVOR_COUNT 158
...
int main () {
    ...
    char *keyAddon[KEY_ADDON_COUNT] = {
        "Blood Amber", "Unique Wedding Ring", "Braided Bauble", "Shrill Whistle"
    };
    ...
    srand(time(NULL));
    // terminal main menu
    // also gotta make it work on the current version as of 7/9/2025 instead of the PTB for The Walking Dead
    printf("Dead by Daylight Randomizer 9.1.0 v2\n");
